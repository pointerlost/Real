...
namespace Real::math {
    ...
    struct Vec4 {
        ...
        explicit constexpr Vec4(f32 v)                      : x(v), y(v), z(v), w(v) {} // Constructor
                 constexpr Vec4(f32 x, f32 y, f32 z, f32 w) : x(x), y(y), z(z), w(w) {} // Constructor
                 constexpr Vec4() = default;                                            // Default Constructor
                           Vec4(const Vec3& xyz, f32 w);                                // Constructor
