...
namespace Real {
    ...
    std::pair<std::vector<Graphics::Vertex>, std::vector<uint32_t>> MeshFactory::CreateTriangle() {
    ...
    std::pair<std::vector<Graphics::Vertex>, std::vector<uint32_t>> MeshFactory::CreateCube() {
        std::vector<Graphics::Vertex> vertices =
		{	// Vertices, Normal, UV
