...
namespace Real {
    ...
    std::pair<std::vector<Graphics::Vertex>, std::vector<uint64_t>> MeshFactory::CreateTriangle() {
    ...
    std::pair<std::vector<Graphics::Vertex>, std::vector<uint64_t>> MeshFactory::CreateCube() {
        std::vector<Graphics::Vertex> vertices =
		{	// Vertices, Normal, UV
