...
namespace Real::assets {
    ...
    public:
        ...
        // Registration
        void Register(const Ref<platform::opengl::OpenGLTexture>& tex);
        ...
        [[nodiscard]]    Vector<Ref<platform::opengl::OpenGLTexture>> GetMaterialTextures(const graphics::Material* mat) const;
