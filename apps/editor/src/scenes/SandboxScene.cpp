...
namespace Real::Editor {
    ...
    void SandboxScene::Load(Scene &scene) {
        ...
        cube.AddComponent<MeshRendererComponent>(
            Services::GetMeshManager().GetPrimitiveUUID(graphics::PrimitiveType::Cube),
            Services::GetMaterialManager().CreateInstance("Marble009")
        );
        ...
        fordCar.AddComponent<ModelComponent>(am.GetModel("Ford_raptor"));
        ...
        island_tree.AddComponent<ModelComponent>(am.GetModel("island_tree"));
        ...
        mountain_road.AddComponent<ModelComponent>(am.GetModel("mountain_road"));
        ...
        porsche_car.AddComponent<ModelComponent>(am.GetModel("porsche_turbo"));
        ...
        city_road.AddComponent<ModelComponent>(am.GetModel("city_road"));
